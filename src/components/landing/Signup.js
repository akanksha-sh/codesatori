...
class SignUpFormBase extends Component {
  ...
  render() {
    ...
    const {
      ...
      const isFormIncomplete = passwordOne === '' || passwordTwo === '' || email === '' || username === '';
      const isInvalid = isEmailInvalid || isUsernameInvalid || isPasswordInvalid || isPasswordNotTheSame || isFormIncomplete;
    ...
    return (
      ...
      <FormGroup className="mb-3">
        <InputGroup>
          <InputGroupAddon addonType="prepend">
            <InputGroupText><i className="material-icons md-dark">account_circle</i></InputGroupText>
          </InputGroupAddon>
          <Input
          type="username"
          name="username"
      ...
      <FormGroup className="mb-3">
        <InputGroup>
          ...
          <FormFeedback valid={false}>Please enter a valid email.</FormFeedback>
        </InputGroup>
      </FormGroup>
      <FormGroup className="mb-3">
        <InputGroup>
          ...
          <FormFeedback valid={false}>Password must be at least 8 characters long, and contain at least 1 capital letter and 1 number.</FormFeedback>
        </InputGroup>
      </FormGroup>
      <FormGroup className="mb-3">
        <InputGroup>
          ...
          invalid={passwordOne !== '' && passwordTwo !== '' && isPasswordNotTheSame}
          valid={passwordOne !== '' && passwordTwo !== '' && !isPasswordNotTheSame} />
          <FormFeedback valid={false}>The passwords don't match!</FormFeedback>
        </InputGroup>
      </FormGroup>
